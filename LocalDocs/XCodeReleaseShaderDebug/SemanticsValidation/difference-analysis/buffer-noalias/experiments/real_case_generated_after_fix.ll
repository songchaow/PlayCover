; ModuleID = '/Users/songdogwang/Codes/PlayCover/LocalDocs/XCodeReleaseShaderDebug/SemanticsValidation/difference-analysis/buffer-noalias/experiments/real_case_generated_after_fix.bc'
source_filename = "/Users/songdogwang/Codes/PlayCover/LocalDocs/XCodeReleaseShaderDebug/SemanticsValidation/difference-analysis/buffer-noalias/experiments/real_case_generated_after_fix.metal"
...
define <{ <4 x half>, <4 x half> }> @xlatMtlMain(ptr addrspace(2) noalias nocapture noundef readonly align 16 dereferenceable(992) %0, ptr addrspace(2) nocapture readonly %1, ptr addrspace(2) nocapture readonly %2, ptr addrspace(2) nocapture readonly %3, ptr addrspace(2) nocapture readonly %4, ptr addrspace(2) nocapture readonly %5, ptr addrspace(2) nocapture readonly %6, ptr addrspace(2) nocapture readonly %7, ptr addrspace(2) nocapture readonly %8, ptr addrspace(2) nocapture readnone %9, ptr addrspace(2) nocapture readonly %10, ptr addrspace(2) nocapture readnone %11, ptr addrspace(1) %12, ptr addrspace(1) %13, ptr addrspace(1) %14, ptr addrspace(1) %15, ptr addrspace(1) %16, ptr addrspace(1) %17, ptr addrspace(1) %18, ptr addrspace(1) %19, ptr addrspace(1) nocapture readnone %20, ptr addrspace(1) nocapture readnone %21, ptr addrspace(1) nocapture readnone %22, ptr addrspace(1) %23, <4 x float> %24, <3 x float> %25) local_unnamed_addr #0 {
...
186:                                              ; preds = %127, %177
  ...
  %279 = tail call { <4 x half>, i8 } @air.sample_texture_2d.v4f16(ptr addrspace(1) nocapture readonly %23, ptr addrspace(2) nocapture readonly %10, <2 x float> %278, i1 true, <2 x i32> zeroinitializer, i1 false, float 0.000000e+00, float 0.000000e+00, i32 0) #3, !alias.scope !48
...
!25 = !{i32 10, !"air.sampler", !"air.location_index", i32 9, i32 1, !"air.arg_type_name", !"sampler", !"air.arg_name", !"sampler_ElementViewSceneWaveTex"}
...
!47 = !{!"/Users/songdogwang/Codes/PlayCover/LocalDocs/XCodeReleaseShaderDebug/SemanticsValidation/difference-analysis/buffer-noalias/experiments/real_case_generated_after_fix.metal"}
!48 = !{!49, !51}
