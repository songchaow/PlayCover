source_filename = "synthetic_structured_merge_late_predecessor.metal"
...
define void @test_structured_merge_late_predecessor(ptr addrspace(1) writeonly %0, i32 %1) #0 {
entry:
  %2 = icmp eq i32 %1, 0
...
10:
  %13 = phi float [ 1.000000e+00, %3 ], [ 2.000000e+00, %11 ], [ 3.000000e+00, %12 ], [ 4.000000e+00, %7 ]
  store float %13, ptr addrspace(1) %0, align 4
  ret void
}
...
!0 = !{ptr @test_structured_merge_late_predecessor, !2, !3}
!1 = !{!4}
!2 = !{}
!3 = !{!5, !6}
