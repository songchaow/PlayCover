; ModuleID = '/Users/songdogwang/Codes/PlayCover/LocalDocs/XCodeReleaseShaderDebug/SemanticsValidation/difference-analysis/buffer-noalias/experiments/minimal_default.bc'
...
define <4 x float> @test_frag(<4 x float> noundef %0, ptr addrspace(2) nocapture noundef readonly align 16 dereferenceable(16) "air-buffer-no-alias" %1) local_unnamed_addr #0 {
