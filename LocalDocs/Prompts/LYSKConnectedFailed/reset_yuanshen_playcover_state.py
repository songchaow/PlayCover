...
示例：
    python3 reset_yuanshen_playcover_state.py --dry-run
    python3 reset_yuanshen_playcover_state.py --yes
    python3 reset_yuanshen_playcover_state.py --bundle-id com.miHoYo.Yuanshen --yes
"""
...
DEFAULT_BUNDLE_ID = "com.miHoYo.Yuanshen"
